...
// import React, { useState, useEffect, useCallback } from 'react';
// import { Copy, Check, Plus, Edit3, Trash2, Bot, Settings } from 'lucide-react';
// import AssistantForm from '../components/AssistantForm';
// import KnowledgeBaseSection from '../components/KnowledgeBaseSection';
// import assistantApi from '../api/assistantApi';
// import knowledgeBaseApi from '../api/knowledgeBaseApi';
...
//           {/* Header */}
//           <div className="mb-8">
//             <h1 className="text-3xl font-bold text-gray-900 mb-2">AI Assistant Management</h1>
//             <p className="text-gray-600">Create, configure, and manage your AI assistants</p>
//           </div>
...
//                 <button
//                   onClick={handleNewAssistantClick}
//                   className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold py-3 px-4 rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-[1.02] mb-6 flex items-center justify-center"
//                 >
...
//                     <p className="text-gray-500 text-lg font-medium mb-2">No assistants yet</p>
...
//                     <div
//                       key={assistant.id}
//                       className={`group relative bg-gray-50 hover:bg-blue-50 border border-gray-200 hover:border-blue-200 rounded-lg p-4 cursor-pointer transition-all duration-200 ${
//                         selectedAssistant?.id === assistant.id ? 'ring-2 ring-blue-500 bg-blue-50 border-blue-200' : ''
//                       }`}
//                       onClick={() => handleSelectAssistant(assistant)}
//                     >
//                       <div className="flex items-start justify-between mb-3">
//                         <div className="flex-1 min-w-0">
//                           <h3 className="text-sm font-semibold text-gray-900 truncate group-hover:text-blue-900">
//                             {assistant.name}
//                           </h3>
//                           <div className="flex items-center mt-1">
//                             <span className="text-xs text-gray-500 mr-2">ID:</span>
//                             <code className="text-xs bg-gray-200 text-gray-700 px-2 py-1 rounded font-mono truncate max-w-24">
//                               {assistant.id}
//                             </code>
//                             <button
//                               onClick={(e) => {
